...
export interface ShieldSubMenuItem extends SubMenuItem {
  superAdminOnly?: boolean;
}

export interface ShieldMenuGroup extends Omit<MenuGroup, 'items'> {
  items: ShieldSubMenuItem[];
}
...
export const buildDynamicMenuGroups = (taskTypes?: TaskTypeMenuMeta[]): ShieldMenuGroup[] => {
